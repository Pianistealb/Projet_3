...
class Labyrinth:
    ...
    def display(self, window):
        ...
        wall_origine = pygame.image.load(c.PICTURE_START).convert()
        wall = pygame.image.load(c.PICTURE_WALL).convert_alpha()
        murdoc = pygame.image.load(c.PICTURE_MURDOC).convert_alpha()
        case_inventory = pygame.image.load(c.PICTURE_INVENTORY).convert_alpha()
        needle = pygame.image.load(c.PICTURE_NEEDLE).convert_alpha()
        tube = pygame.image.load(c.PICTURE_PLASTIC_TUBE).convert_alpha()
        ether = pygame.image.load(c.PICTURE_ETHER).convert_alpha()
        ...
        for num_line, line in enumerate(self.structure):
            ...
            for num_case, sprite in enumerate(line):
                ...
                x = num_case * c.SIZE_SPRITE
                y = num_line * c.SIZE_SPRITE
